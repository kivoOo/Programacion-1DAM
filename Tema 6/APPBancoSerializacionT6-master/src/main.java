...
public class main {
    ...
    public static void main(String[] args) {
        ...
        try {
            gestion = new GestionCuentas();
        } catch (Exception e) {
            System.out.println("El proceso de recuperación de cuentas del disco falló.....");
        }
        ...
        if (gestion != null) {
            ...
            while (op < 9) {
                ...
                System.out.println("8. Realizar un bizum");
                ...
                switch (op) {
                    ...
                    case 2: //Borrado de cuentas
                        ...
                        if (resultado)
                            System.out.printf("La operación se realizó con éxito, cuenta %d borrada\n", numCuenta);
                    ...
                    case 9:
                        try {
                            gestion.SalvarCuentas();
                            System.out.println("La aplicación ha sido guardada en disco, hasta la próxima");
                        } catch (IOException e) {
                            System.out.println("Hubo un error al guardar en disco, se perderán los cambios.");
                        }
                        System.out.println("Pulse enter para continuar........");
                        teclaContinuar = S.nextLine();
                        break;
            ...
            System.out.println("Compruebe el fichero de datos y vuelva a arrancar la aplicación");
        }
    }
