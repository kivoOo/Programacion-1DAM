...
<html>
    ...
    <section id="sobremi" class="seccion contenedor">
        ...
        <div class="sobremi clearfix">  
            <ul>
                <li>Introduzca los datos de la Cuenta</li>
            ...
            <form class="form-inline" action="operar.jsp">
                <label class="sr-only" for="inlineFormInputName2">Número de cuenta</label>
                <input type="text" class="form-control mb-2 mr-sm-2" name="numcuenta" id="inlineFormInputName2" placeholder="Num Cuenta" required>
                ...
                <input type="hidden" name="operacion" value="ingresardinero"/> 
