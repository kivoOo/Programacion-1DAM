...
<html>
    ...
    <section id="sobremi" class="seccion contenedor">
        <h2>Realizar un bizum</h2>
        <br>
        <div class="sobremi clearfix">  
            <ul>
                <li>Introduzca los datos de los móviles</li>
                <li>y la cantidad de dinero a traspasar</li>
            </ul>
            <br>
            <br>

            <form class="form-inline" action="operar.jsp">
                <label class="sr-only" for="inlineFormInputName2">Móvil ordenante</label>
                <input type="text" class="form-control mb-2 mr-sm-2" name="nummovil1" id="inlineFormInputName2" placeholder="Mov. Ordenante" required>
                <label class="sr-only" for="inlineFormInputName2">Móvil destinatario</label>
                <input type="text" class="form-control mb-2 mr-sm-2" name="nummovil2" id="inlineFormInputName2" placeholder="Mov. Destinatario" required>
                ...
                <input type="hidden" name="operacion" value="bizum"/> 
