<%-- 
    Document   : sacardinero
    Created on : 12 feb. 2020, 0:14:45
    Author     : carlos
--%>
...
<html>
    <head>
        ...
        <title>Traspaso entre cuentas de dinero</title>
    ...
    <section id="sobremi" class="seccion contenedor">
        <h2>Traspaso de dinero entre cuentas</h2>
        <br>
        <div class="sobremi clearfix">  
            <ul>
                <li>Introduzca los datos de las Cuentas</li>
                <li>y la cantidad de dinero a ingresar</li>
            </ul>
            <br>
            <br>

            <form class="form-inline" action="operar.jsp">
                <label class="sr-only" for="inlineFormInputName2">Cuenta ordenante</label>
                <input type="text" class="form-control mb-2 mr-sm-2" name="numcuenta1" id="inlineFormInputName2" placeholder="Ordenante" required>
                <label class="sr-only" for="inlineFormInputName2">Cuenta destinataria</label>
                <input type="text" class="form-control mb-2 mr-sm-2" name="numcuenta2" id="inlineFormInputName2" placeholder="Destinataria" required>
                <label class="sr-only" for="inlineFormInputGroupUsername2">Cantidad</label>
                <div class="input-group mb-2 mr-sm-2">
                    <div class="input-group-prepend">
                        <div class="input-group-text">-</div>
                    </div>
                    <input type="text" class="form-control" name="cantidad" id="inlineFormInputGroupUsername2" placeholder="Cantidad" required>
                </div>
                <input type="hidden" name="operacion" value="traspasardinero"/> 
