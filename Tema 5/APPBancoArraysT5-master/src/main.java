...
public class main {
    ...
    public static void main(String[] args) {
        ...
        Cliente cliente2 = new Cliente("Pepe","Lopez Caro","12345678Z","1234",
                "pepe@pepe",fecha = new Date());
        Cuenta cuenta1 = new Cuenta(1,cliente1,1.5f);
        Cuenta cuenta2 = new Cuenta(2,cliente2,2.0f);
        gestion.añadirCuenta(cuenta1);
        gestion.añadirCuenta(cuenta2);
        while (op < 8  ) {
            op = 0;
            System.out.println("\nBienvenido al banco Docente");
            System.out.println("Actualmente tenemos " + gestion.getNumCuentas() + " cuentas");
                ...
                case 1: //Creacion de cuentas
                    ...
                    if (!comprobarDNI(dni)){
                        ...
                        if (c == null){ //Si el cliente no existe
                            ...
                            Cuenta cuenta = new Cuenta(gestion.getNumCuentas()+1,c,interes);
                            if (gestion.añadirCuenta(cuenta)) System.out.println("La cuenta ha sido creada, " +
                                    "el número de cuenta es: " + cuenta.getNumero());
                            else System.out.println("La cuenta no ha podido ser creada. Memoria llena");
